...
$query4 = ("INSERT INTO p_credit (paymentID, fullname, email, address, bankname, pinno, expire_date, itemID,  amount, date)
VALUES ('','".$fullname."','".$email."','".$address."','".$bankname."','".$pinno."','".$exdate."','".$itemID."','".$amount."','".$date."')");
$success4 = mysql_query($query4);

$query5 =("INSERT INTO item_order (orderID, email, itemID, name, price, quantity, amount, type, status, date)
VALUES ('','".$email."','".$itemID."','".$name."','".$price."','".$quantity."','".$amount."','Credit Card','Pending','".$date."' )");
$success5 = mysql_query($query5);

$query6 = ("INSERT INTO p_shipping (shippingID, email, status, date)
