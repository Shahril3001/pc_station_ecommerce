...
$query5 = ("INSERT INTO p_debit (paymentID, fullname, email, address, bankname, pinno, expire_date, itemID,  amount, date)
...
VALUES ('','".$email."','".$itemID."','".$name."','".$price."','".$quantity."','".$amount."','Debit Card','Pending','".$date."')");
