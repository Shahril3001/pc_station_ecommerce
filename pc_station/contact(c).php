	...
	<div id="header">
		...
		<div id="navigation">
			...
			echo"<li><a href='index2.php?email=".$email."'>Home</a></li>
			    ...
			    <li><a href='contact(c).php?email=".$email."' class='active'>Contact Us</a></li>";
			?>
...
function myFunction() {
	...
	<div id="main">
		...
		<div id="content">
			<h2>CONTACT US</h2><hr>
        <p>If you have any suggestion or complain, you can submit the message with fill in your name and email below.</p></br>
		<?php
$email=$_GET['email'];
echo "<form action='contact(c)2.php?email=".$email."' method='post' enctype='multipart/form-data'>";
 ?>
		  ...
		  <input type="hidden" name="date" value="<?php echo date("Y-m-d g:i:s");;?>"/>
			...
			<td width="365" style="background-color:white;"><input type="text" name="fullname" value="<?php echo $query2['fullname']; ?>" placeholder="(Required)"/></td></tr>
            <tr>
			<th style="color:white;">Email:</th>
			<td style="background-color:white;"><input type="text" name="email" value="<?php echo $query2['email']; ?>" placeholder="(Required)"/></td></tr>
			<tr>
