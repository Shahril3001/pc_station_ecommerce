...
<center><h2>CUSTOMER LOGIN (INVALID)</h2><hr>
<p>Please enter your email and password to login.</p></br></br>
<input type='text' name='email' placeholder="Email" class="textox"></br></br>
...
<p>Don't have account yet. Please click <a href="cusregister.php">Register</a> to create new account.</p>
</center>
</div>
