...
<h2>PAYMENT FORM (DEBIT CARD)</h2><hr></br><center>
<?php
echo "<table width='960px'>";
echo "<form action='debit2.php?email=".$email."' method='post' enctype='multipart/form-data'>";
 ?>
...
<td><input type="text" name="pinno" placeholder="(Required)" size=30 /></td>
</tr>
